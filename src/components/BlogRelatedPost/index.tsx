...
export default function BlogRelatedPost({ post }: any) {
  ...
  return (
    <div className="border-t border-jacarta-100 dark:border-jacarta-600      bg-gradient-to-b from-white to-light-base dark:from-jacarta-600 dark:to-jacarta-900 py-24 sm:py-32">
