    ...
    >
      <div className="flex items-center px-6 py-6 xl:px-24">
        ...
        <a href="index.html" className="shrink-0">
          <Image src="img/logo_white.png" className="max-h-7" alt="Xhibiter | NFT Marketplace" height={28} width={100}/>
        </a>
        ...
        >
          ...
          >
            {/* <!-- Mobile Logo --> */}
            <a href="index.html" className="shrink-0">
              <Image src="img/logo.png" className="max-h-7 dark:hidden" alt="Xhibiter | NFT Marketplace" height={28} width={100}/>
              <Image src="img/logo_white.png" className="hidden max-h-7 dark:block" alt="Xhibiter | NFT Marketplace" height={28} width={100}/>
            </a>
