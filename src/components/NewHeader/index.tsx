            ...
            <div className="ml-8 hidden lg:flex xl:ml-12">
              ...
              >
                <svg
                  ...
                  width="24"
                  height="24"
                  className="dark-mode-light h-4 w-4 fill-jacarta-700 dark:fill-white transition-colors group-hover:fill-white group-focus:fill-white dark:hidden"
                >
                  <path fill="none" d="M0 0h24v24H0z" />
                  <path
                ...
                <svg
                  ...
                  width="24"
                  height="24"
                  className="dark-mode-dark hidden h-4 w-4 fill-jacarta-700 dark:fill-white transition-colors group-hover:fill-white group-focus:fill-white dark:block"
                >
                  <path fill="none" d="M0 0h24v24H0z" />
                  <path
          ...
          <div className="ml-auto flex lg:hidden">
            ...
            >
              <svg
                ...
                width="24"
                height="24"
                className="h-4 w-4 fill-jacarta-700 dark:fill-white transition-colors group-hover:fill-white group-focus:fill-white"
              >
                <path fill="none" d="M0 0h24v24H0z" />
